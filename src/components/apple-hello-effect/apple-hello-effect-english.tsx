...
// Adapted from the MIT-licensed Apple Hello Effect by Chánh Đại (ncdai/chanhdai.com).
...
export type AppleHelloEffectEnglishProps = Omit<
  ...
  "durationScale" | "onAnimationComplete" | "static"
> & {
  /**
  ...
  */
  ...
  /** Renders the completed drawing without handwriting motion. */
  static?: boolean
  ...
  return (
    ...
    >
      ...
      <motion.path
        ...
        initial={isStatic ? false : initialProps}
        animate={animateProps}
        transition={{
          duration: isStatic ? 0 : calc(0.8),
          ease: "easeInOut",
