...
const colorMap: Record<string, string> = {
  ...
  "TypeScript": "bg-blue-700/10 text-blue-400 border-blue-700/30",
  ...
  "CSS": "bg-blue-600/10 text-blue-400 border-blue-600/30",
  ...
  "Redux": "bg-purple-600/10 text-purple-400 border-purple-600/30",
};
